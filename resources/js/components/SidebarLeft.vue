        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <router-link to="/admin/mediamanager"
                            :class="$route.path.startsWith('/admin/mediamanager') ? 'active' : ''" class="nav-link">
                    ...
                    <li class="nav-item">
                        <router-link to="/admin/sliders"
                            :class="$route.path.startsWith('/admin/sliders') ? 'active' : ''" class="nav-link">
                            <i class="nav-icon fas fa-calendar-alt"></i>
                            <p>
                                Sliders
                            </p>
                    ...
                    <li class="nav-item">
                        <router-link to="/admin/attributevalues"
                            :class="$route.path.startsWith('/admin/attributevalues') ? 'active' : ''" class="nav-link">
                            <i class="nav-icon fas fa-calendar-alt"></i>
                            <p>
                                Attribute Values
                            </p>
