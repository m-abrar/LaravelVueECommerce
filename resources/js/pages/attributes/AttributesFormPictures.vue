...
export default {
  ...
  setup() {
    ...
    const addRemoveAttachment = (attachment_id) => {
      ...
      var feature_image_url = `/api/attribute/${route.params.id}/media/add-remove/${attachment_id}`;
    ...
    const getMediaFiles = () => {
      axios.get(`/api/attribute/${route.params.id}/media/all`)
        .then((response) => {
    ...
    const updateOrder = () => {
      ...
      axios.put('/api/attribute/images-order-update', {
    ...
    const featureAttachment = (attachment_id) => {
      ...
      var feature_image_url = `/api/attribute/${route.params.id}/media/featured-update/${attachment_id}`;
