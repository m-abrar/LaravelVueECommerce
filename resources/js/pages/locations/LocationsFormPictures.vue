...
export default {
  ...
  setup() {
    ...
    const addRemoveAttachment = (attachment_id) => {
      ...
      var feature_image_url = `/api/location/${route.params.id}/media/add-remove/${attachment_id}`;
    ...
    const getMediaFiles = () => {
      axios.get(`/api/location/${route.params.id}/media/all`)
        .then((response) => {
    ...
    const updateOrder = () => {
      ...
      axios.put('/api/location/images-order-update', {
    ...
    const featureAttachment = (attachment_id) => {
      ...
      var feature_image_url = `/api/location/${route.params.id}/media/featured-update/${attachment_id}`;
