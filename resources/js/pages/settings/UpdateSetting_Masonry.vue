                        ...
                        <form @submit.prevent="updateSettings()">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input v-model="settings.ownerName" type="text" class="form-control" id="ownerName"
                                ...
                                <div class="form-group">
                                    ...
                                    <input v-model="settings.whatsapp" type="text" class="form-control" id="whatsapp"
                        ...
                        <form @submit.prevent="updateSettings()">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input v-model="settings.googleMap" type="text" class="form-control" id="googleMap"
                                ...
                                <div class="form-group">
                                    ...
                                    <input v-model="settings.copyright" type="text" class="form-control" id="copyright"
